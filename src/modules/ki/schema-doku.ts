...
- **dienst_status**: Dienste-Wächter — Zustand je externem Dienst (dienst 'dhl'|'shopify'|'mail'|'ki'|'sprache'|'druckbruecke'|'telegram', status 'ok'|'gestoert'|'unbekannt', fehler, seit, geprueft_at, fehlversuche, dauer_ms); gepflegt vom Cron wache alle fünf Minuten.
