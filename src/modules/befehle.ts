...
const SEITEN: { href: string; label: string; area: Area; prozess?: string[] }[] = [
  ...
  // Einstellungen: je Bereich ein Eintrag (Landkarte modules/einstellungen/bereiche.ts,
  // Abgleich wächter-geprüft in tests/einstellungen.test.ts).
  ...
  { href: '/einstellungen/registrierungen', label: 'Einstellungen · Registrierungen (Startseite)', area: 'einstellungen' },
  { href: '/einstellungen/gefahrenzone', label: 'Einstellungen · Gefahrenzone', area: 'einstellungen' },
