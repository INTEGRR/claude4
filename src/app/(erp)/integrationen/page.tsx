...
export default async function IntegrationenPage() {
  ...
  return (
    <>
      ...
      {!shopifyConfigured() && (
        <div className="notice warn">
          Shopify ist nicht konfiguriert — was fehlt und wie die App eingerichtet wird, steht unter{' '}
          <Link href="/einstellungen/anbindungen">Einstellungen → Schnittstellen</Link>.
        </div>
      )}
