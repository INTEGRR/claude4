 ...
 *
 * Öffnen/Schließen läuft über das NATIVE popover-Attribut, nicht über
 * React-State: die dynamischen Seiten hydrieren spürbar spät, und ein
 * onClick-Knopf ist bis dahin tot ("öffnet erst nach dem dritten Klick").
 * Das Popover schaltet der Browser selbst — der erste Klick sitzt, auch
 * bevor irgendein JavaScript geladen ist.
 */
export function TicketOverlay() {
  ...
  return (
    <>
      <button type="button" className="ticket-tab" popoverTarget="fehler-panel">
        Fehler?
      </button>
      ...
      >
        ...
        >
          <label className="field">
            ...
            <input name="titel" required maxLength={200} ref={titelRef} />
          </label>
          <div className="row">
            <label className="field">
              <span>Schwere</span>
